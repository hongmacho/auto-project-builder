...
프로젝트가 완료될 때마다 5개 카테고리의 고도화 전략을 생성하여 `projects/{slug}/user-suggest.html`에 저장합니다. 프로젝트마다 독립된 파일로 생성되며, 5개 프로젝트이면 5개의 개별 파일이 만들어집니다.
...
│       │   └── ROADMAP.md
│       ├── README.md              ← 자동 생성
│       ├── user-suggest.html      ← 해당 프로젝트 전용 고도화 가이드 (독립 파일)
│       └── ... (소스 코드)
├── report_data/
│   ├── {slug}_log.json
...
프로젝트 완료 직후 해당 프로젝트 디렉토리에 독립적으로 생성됩니다. 포함 내용:
- 빠른 개선, 기능 고도화, 기술 개선, 성장 전략, 수익화 아이디어
- 제안별 우선순위·예상 공수 레이블
